...
let GRID_REGION = MKCoordinateRegion(center: GRID_CENTER, latitudinalMeters: GRID_HEIGHT_METERS+4*METERS_PER_MILE, longitudinalMeters: GRID_WIDTH_METERS+4*METERS_PER_MILE)
let GRID_ROWS = 16
let GRID_COLUMNS = 20
